...
class wc4bp_screen{
    ...
    {
        add_action( 'wc4bp_after_track_body', array($this,'wc4bp_output_tracking_order' ));
        add_action( 'wc4bp_after_track_heading',array($this, 'wc4bp_setup_tracking_order'));
    }
    ...
    function wc4bp_screen_settings() {
        ...
        add_action( 'bp_template_title', array($this,'wc4bp_screen_settings_title' ));
