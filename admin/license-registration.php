...
class WC4BP_Key_Registration_Menu {
	...
	public function add_menu() {
		...
		$page = add_submenu_page( 'wc4bp_options_page', 'WC4BP', 'License Activation', 'manage_options', 'license_registration_dashboard', array( $this, 'config_page') );
		add_action( 'admin_print_styles-' . $page, array( $this, 'css_scripts' ) );
	}

	// Draw option page
	public function config_page() {
		$settings_tabs = array( 'license_registration_dashboard' => 'Activate License', 'wc4bp_deactivation' => 'License Deactivation' );
	...
	public function load_settings() {
		...
		// API Key
		add_settings_section( 'api_key', 'License Information', array( $this, 'wc4bp_api_key_text' ), 'license_registration_dashboard' );
		add_settings_field( 'api_key', 'API License Key', array( $this, 'wc4bp_api_key_field' ), 'license_registration_dashboard', 'api_key' );
		add_settings_field( 'api_email', 'License email', array( $this, 'wc4bp_api_email_field' ), 'license_registration_dashboard', 'api_key' );
...
$wc4bp_key_registration_menu = new WC4BP_Key_Registration_Menu();
