	...
	try {
		...
		if ( bp_is_active( 'xprofile' ) && class_exists( 'BP_XProfile_Group' ) ) {
			...
			if ( $insert_billing_group ) {
				$billing['group_id'] = xprofile_insert_field_group(
					array(
				...
				$billing['first_name'] = xprofile_insert_field(
					array(
				...
				$billing['last_name']  = xprofile_insert_field(
					array(
						'field_group_id' => $billing['group_id'],
						'type'           => 'textbox',
				...
				$billing['company']    = xprofile_insert_field(
					array(
						'field_group_id' => $billing['group_id'],
						'type'           => 'textbox',
				...
				$billing['address_1']  = xprofile_insert_field(
					array(
						'field_group_id' => $billing['group_id'],
						'type'           => 'textbox',
				...
				$billing['address_2']  = xprofile_insert_field(
					array(
						'field_group_id' => $billing['group_id'],
						'type'           => 'textbox',
				...
				$billing['city']       = xprofile_insert_field(
					array(
						'field_group_id' => $billing['group_id'],
						'type'           => 'textbox',
						'name'           => __( 'City', 'wc4bp' ),
				...
				$billing['postcode']   = xprofile_insert_field(
					array(
						'field_group_id' => $billing['group_id'],
						'type'           => 'textbox',
				...
				$billing['country']    = xprofile_insert_field(
					array(
						'field_group_id' => $billing['group_id'],
						'type'           => 'selectbox',
						'order_by'       => 'asc',
				...
				foreach ( $geo->get_countries() as $country_code => $country ) {
					...
					VALUES (%d, %d, 'option', %s, '', 0, %d, %d)",
							array( $billing['group_id'], $billing['country'], $country, $counter, $is_default )
						)
					);
					$counter ++;
				}

				$billing['state'] = xprofile_insert_field(
					array(
						'field_group_id' => $billing['group_id'],
						'type'           => 'textbox',
				...
				$billing['email'] = xprofile_insert_field(
					array(
						'field_group_id' => $billing['group_id'],
						'type'           => 'textbox',
				...
				$billing['phone'] = xprofile_insert_field(
					array(
						'field_group_id' => $billing['group_id'],
						'type'           => 'textbox',
						'name'           => __( 'Phone', 'wc4bp' ),
				...
				$billing['fax']   = xprofile_insert_field(
					array(
						'field_group_id' => $billing['group_id'],
						'type'           => 'textbox',
						'name'           => __( 'Fax', 'wc4bp' ),
			...
			if ( $insert_shipping_group ) {
				$shipping['group_id'] = xprofile_insert_field_group(
					array(
				...
				$shipping['first_name'] = xprofile_insert_field(
					array(
				...
				$shipping['last_name']  = xprofile_insert_field(
					array(
						'field_group_id' => $shipping['group_id'],
						'type'           => 'textbox',
						'name'           => __( 'Last Name', 'wc4bp' ),
				...
				$shipping['company']    = xprofile_insert_field(
					array(
						'field_group_id' => $shipping['group_id'],
						'type'           => 'textbox',
						'name'           => __( 'Company', 'wc4bp' ),
				...
				$shipping['address_1']  = xprofile_insert_field(
					array(
						'field_group_id' => $shipping['group_id'],
						'type'           => 'textbox',
						'name'           => __( 'Address 1', 'wc4bp' ),
				...
				$shipping['address_2']  = xprofile_insert_field(
					array(
						'field_group_id' => $shipping['group_id'],
						'type'           => 'textbox',
						'name'           => __( 'Address 2', 'wc4bp' ),
				...
				$shipping['city']       = xprofile_insert_field(
					array(
						'field_group_id' => $shipping['group_id'],
						'type'           => 'textbox',
						'name'           => __( 'City', 'wc4bp' ),
				...
				$shipping['postcode']   = xprofile_insert_field(
					array(
						'field_group_id' => $shipping['group_id'],
						'type'           => 'textbox',
						'name'           => __( 'Postcode', 'wc4bp' ),
				...
				$shipping['country']    = xprofile_insert_field(
					array(
						'field_group_id' => $shipping['group_id'],
						'order_by'       => 'asc',
						'type'           => 'selectbox',
				...
				foreach ( $geo->get_countries() as $country_code => $country ) {
					...
					(group_id, parent_id, type, name, description, is_required, option_order, is_default_option)
					VALUES (%d, %d, 'option', %s, '', 0, %d, %d)",
							array( $shipping['group_id'], $shipping['country'], $country, $counter, $is_default )
						)
					);
					$counter ++;
				}

				$shipping['state'] = xprofile_insert_field(
					array(
						'field_group_id' => $shipping['group_id'],
						'type'           => 'textbox',
						'name'           => __( 'State/County', 'wc4bp' ),
