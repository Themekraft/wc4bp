...
echo $this->disable_class_tag( 'p', wc4bp_base::$starter_plan_id ); ?>>
    <label>
        <b><?php _e( 'Change \'Woocommerce My Account Page Prefix\' url.', 'wc4bp' ); ?></b>&nbsp; <?php _e( 'This preffix is used to print the page name in the url. If you leave it empty the system will use the default value. When you change the old page will be move to the trash.', 'wc4bp' ); ?>
        <br/>
