...
_e( '<p>By default all account related WooCommerce pages are included into the BuddyPress member profiles. When you turn off one of the next, the page(s) will be complete remove.</p>', 'wc4bp' );
