...
<p <?php echo $this->disable_class_tag( 'p', wc4bp_base::$starter_plan_id ); ?>>
    <label>
        ...
        <br/>
        <input <?php echo $this->disable_input_tag( 'text', wc4bp_base::$starter_plan_id ); ?> name='wc4bp_options[tab_my_account_shop_label]' type='text' value='<?php echo sanitize_text_field( $tab_my_account_shop_label); ?>'  />
...
<p <?php echo $this->disable_class_tag( 'p', wc4bp_base::$starter_plan_id ); ?>>
    <label>
        ...
        <br/>
        <input <?php echo $this->disable_input_tag( 'text', wc4bp_base::$starter_plan_id ); ?> name='wc4bp_options[tab_my_account_shop_url]' type='text' value='<?php echo sanitize_title( $tab_my_account_shop_url); ?>'  />
