...
<p <?php echo $this->disable_class_tag( 'p', wc4bp_base::$starter_plan_id ); ?>>
    <label>
        ...
        <b><?php _e( 'Turn off \'Woocommerce My Account\' redirection.', 'wc4bp' ); ?></b>&nbsp; <?php _e( 'This option is useful when you have problem with 3rd Woocommerce plugins. It disable only the My Account redirection.', 'wc4bp' ); ?>
    </label>
</p>
