...
<label>
	...
	<p <?php echo $this->disable_class_tag( 'p', wc4bp_base::$starter_plan_id ); ?>>
		...
		<option value='processing' <?php if( isset( $wc4bp_options_notifications['notifications_order_status'] ) ){ selected( $wc4bp_options_notifications['notifications_order_status'], 'processing' ); } ?>>Processing</option>
        <option value='pending' <?php if( isset( $wc4bp_options_notifications['notifications_order_status'] ) ){ selected( $wc4bp_options_notifications['notifications_order_status'], 'pending' ); } ?>>Pending Payment</option>
